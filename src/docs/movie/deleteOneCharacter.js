module.exports = {
    delete: {
        ...
        description: 'Desvincula un personaje de una película/serie mediante sus respectivos IDs. Devuelve un mensaje indicando el id del personaje que se ha quitado y el id de la película/serie afectada.',
